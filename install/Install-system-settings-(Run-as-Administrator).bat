...
"%REG%" ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\services\Tcpip\ServiceProvider" /v LocalPriority             /t REG_DWORD /d 0x00000005 /f >nul
"%REG%" ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\services\Tcpip\ServiceProvider" /v HostsPriority             /t REG_DWORD /d 0x00000004 /f >nul
...
"%REG%" ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\services\Dnscache\Parameters"   /v NegativeCacheTime         /t REG_DWORD /d 0x0000012c /f >nul
"%REG%" ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\services\Dnscache\Parameters"   /v NetFailureCacheTime       /t REG_DWORD /d 0x0000001e /f >nul
"%REG%" ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\services\Dnscache\Parameters"   /v NegativeSOACacheTime      /t REG_DWORD /d 0x00000078 /f >nul
